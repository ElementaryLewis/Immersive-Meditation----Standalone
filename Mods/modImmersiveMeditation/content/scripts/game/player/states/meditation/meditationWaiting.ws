...
{
	private var TARGET_HOURS_PER_MINUTE : float; //Immersive Meditation		
	...
	event OnEnterState( prevStateName : name )
	{
		...
		TARGET_HOURS_PER_MINUTE = thePlayer.mImmersive.medHPS * 60; //Immersive Meditation
